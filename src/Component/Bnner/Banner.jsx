        ...
        <div>
            <div className='relative'>
                ...
                <div className="absolute top-0 bg-gradient-to-r from-[#15151500] to-[#151515] w-full h-full">
                    <motion.div initial={{ y: -150 }} animate={{ y: 0 }} transition={{ duration: "2", delay: "1" }} className='absolute space-y-2 md:space-y-5 right-2 md:right-7 md:pl-5 pl-3 md:top-1/3 '>
